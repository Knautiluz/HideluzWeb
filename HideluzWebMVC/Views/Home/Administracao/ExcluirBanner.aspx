<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Default.master" AutoEventWireup="true" CodeFile="ExcluirBanner.aspx.cs" Inherits="Views_Home_Administracao_DeletarBanner" %>
    ...
    <div id="carousel-index" class="container-fluid">
        <div class="row">
            <div class="col-md-4 col-lg-4 offset-md-4 offset-lg-4">
                <h3 class="text-center mt-5">Escolha o Banner que deseja deletar!</h3>
                ...
                <form accept-charset="uft-8" method="post" enctype="multipart/form-data" target="_self">
                    ...
                    <div class="row d-inline">
                        <div class="col-md-6 col-lg-6 offset-md-3 offset-lg-3 mb-5">
                            <button class="btn btn-block btn-hideluz" type="submit">Excluir Banner</button>
                        </div>
                    </div>
                </form>
            </div>
