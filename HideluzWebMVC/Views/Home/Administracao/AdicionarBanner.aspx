<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Default.master" AutoEventWireup="true" CodeFile="AdicionarBanner.aspx.cs" Inherits="Views_Home_Cadastro" %>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 offset-md-3 offset-lg-3">
                            <div class="form-group">
                                ...
                                <small id="bannerTitleHelp" class="form-text text-muted">Ex: nossa foto de capa</small>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-lg-6 offset-md-3 offset-lg-3">
                            <div class="form-group">
                                <label for="BannerDesc">Descrição do Banner</label>
                                <input required type="text" class="form-control" id="BannerDesc" name="BannerDesc" placeholder="Escreva a descrição do banner">
                                <small id="bannerDescHelp" class="form-text text-muted">Essa capa é da nossa pagina principal</small>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-lg-6 offset-md-3 offset-lg-3">
                            <div class="form-group">
                                <label for="BannerImg">Imagem do Banner</label>
