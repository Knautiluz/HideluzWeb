        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12 text-center">
                <div class="btn-group btn-group-lg" role="group" aria-label="Botões do Banner">
                    ...
                    <a href="/Views/Home/Administracao/ModificarBanner.aspx" class="btn btn-secondary">Modificar Banner</a>
                    <a class="btn btn-secondary">Consultar Banners</a>
                    <a href="/Views/Home/Administracao/ExcluirBanner.aspx" class="btn btn-secondary">Excluir Banner</a>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-12 text-center">
                <div class="btn-group btn-group-lg" role="group" aria-label="Botões do Banner">
                    ...
                    <a href="/Views/Home/Administracao/ModificarPlano.aspx" class="btn btn-secondary">Modificar Planos</a>
                    <a class="btn btn-secondary">Consultar Planos</a>
                    <a href="/Views/Home/Administracao/ExcluirPlano.aspx" class="btn btn-secondary">Excluir Planos</a>
                </div>
            </div>
        </div>
    </div>
